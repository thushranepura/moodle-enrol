...
switch ($action) {
    ...
    case 'enrol':
        ...
        if ($plugin->allow_enrol($instance) && has_capability('enrol/'.$plugin->get_name().':enrol', $context)) {
           ...
           // $plugin->enrol_users($instance, $user->id, $roleid, $timestart, $timeend, null, $recovergrades);
            
            $plugin->enrol_manual($instance, $user->id, $roleid, $timestart, $timeend, null, $recovergrades);
