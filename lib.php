...
class enrol_manual_plugin extends enrol_plugin {
    ...
    protected function email_welcome_message($instance, $user) {
        ...
        if (trim($instance->customtext1) !== '') {
         ...
         //  $messagehtml = text_to_html($messagetext, null, false, true);
            ...
            $customemailhtml = '<p>&nbsp;</p>' . '<img src="' . $CFG->wwwroot . '/enrol/manual/logoinemail.png' . '" alt="" align="right">' .
                    '<p>Dear ' . $user->firstname . '</p>' .
                    '<p>Thank you for enrolling on the ' . format_string($course->fullname, true, array('context' => $context)) . 'training course &nbsp;</p>' .
                    '<p>Your course is accessed via the On-line portal.&nbsp; To access your course please click here.</p>' .
                    $CFG->wwwroot . '/course/view.php?id=' . $course->id
                    . '<p>If you are logging into the website for the first time, please update our password.</p>
                    <p><strong>Sample Co LTD</strong></p>
                    <h3>Tel: 1111111&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</h3>';



            $messagehtml = $customemailhtml;
      ...
      $subject = 'Welcome to  '. format_string($course->fullname, true, array('context'=>$context));
     ...
     * @return void
     */
    public function enrol_users(stdClass $instance, $userid, $roleid = null, $timestart = 0, $timeend = 0, $status = null, $recovergrades = null) {
    ...
    public function enrol_manual( stdClass  $instance, $userid, $roleid, $timestart, $timeend, $status = null , $recovergrades ) {
        global $DB, $USER, $CFG;

  
        
        
        $this->enrol_users($instance, $userid, $roleid, $timestart, $timeend, null, $recovergrades);
